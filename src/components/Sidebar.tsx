...
function SectionCableMark({ section }: { section: SidebarSection }) {
  return <span className={`sectionCableMark ${section}`} aria-hidden="true"><i /><i /><b /></span>;
}
...
export function Sidebar(props: SidebarProps) {
  ...
  const heading = (section: SidebarSection, label: string, addLabel: string, onAdd: () => void) => <div className="sectionHeading">
    ...
    <SectionCableMark section={section} />
